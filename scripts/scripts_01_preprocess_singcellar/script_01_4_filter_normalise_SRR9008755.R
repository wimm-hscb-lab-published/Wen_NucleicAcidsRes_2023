...
# Read STARsolo files
data_matrices_dir <- "../../data/STARsolo/SRR9008755/Solo_out/Gene/filtered/"
Sample <- new("SingCellaR")
Sample@dir_path_10x_matrix <- data_matrices_dir
Sample@sample_uniq_id <- "SRR9008755"
...
# QC plots
    ...
    # UMIs vs. the number of detected genes/cell
        ...
        # Save file
        #path <- "/Users/seanwen/Documents/U2AF1_2019/Ou/Gene/SRR9008755/QC/"
...
dir.create(path, showWarnings=FALSE)
file <- "SRR9008755.SingCellaR.rdata"
