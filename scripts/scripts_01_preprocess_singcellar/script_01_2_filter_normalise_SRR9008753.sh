...
# Read STARsolo files
data_matrices_dir <- "../../data/STARsolo/SRR9008753/Solo_out/Gene/filtered/"
Sample <- new("SingCellaR")
Sample@dir_path_10x_matrix <- data_matrices_dir
Sample@sample_uniq_id <- "SRR9008753"
...
# QC plots
    ...
    # UMIs vs. the number of detected genes/cell
        ...
        data$outlier <- ifelse(data$UMI_count > 70000, "yes", "no")
        ...
        # Save file
        #path <- "/Users/seanwen/Documents/U2AF1_2019/Ou/Gene/SRR9008753/QC/"
...
dir.create(path, showWarnings=FALSE)
file <- "SRR9008753.SingCellaR.rdata"
